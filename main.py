...
if not os.path.exists("./MTdata/default.html"):
...
if not os.path.exists("./MTdata/trails/smooth.html"):
    open("./MTdata/smooth.html", "w").write(
"""
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Blurred Glowing Mouse Trail</title>
  <style>
    body {
      margin: 0;
      overflow: hidden;
